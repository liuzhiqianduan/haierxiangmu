(function($){
    $.fn.dragverify = function(params){
        ...
        var htmls = '<div class="dragverifybg"></div><div class="dragverifytext" onselectstart="return false;" unselectable="on"style="color:#999">请按住滑块，拖到最右边</div><div class="block blockbg"></div>';
        ...
        function verifySuc(){
            ...
            drafverifytext.text("请按住滑块，拖到最右边");
